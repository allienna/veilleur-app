"""Secret Manager helper for the Hello-Veilleur spike.

Constitution §2 principle 2: `ANTHROPIC_API_KEY` MUST NOT be in env by default.
This module refuses to import if the variable is set, blocking accidental
activation of the API-key fallback path.
"""
...
def _assert_anthropic_api_key_absent() -> None:
    if os.environ.get("ANTHROPIC_API_KEY") is not None:
        msg = (
            ...
            "API-key fallback path by default — unset it before running the spike, or "
